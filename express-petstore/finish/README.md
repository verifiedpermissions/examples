...
This is a sample application with a React frontend and Express.js backend. This `finish` version of the application contains additional code, Cedar schemas, and Cedar policies to integrate the application with Amazon Verified Permissions.

## Project Structure

The `finish` project is organized into three main directories:
